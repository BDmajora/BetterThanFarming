...
public class BlockCropsTorchFlower extends BlockFlower {
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		if (meta != 3) {
			return new ItemStack[]{new ItemStack(BetterThanFarmingItems.seedsTorchFlower)};
		}
		return new ItemStack[]{new ItemStack(BetterThanFarmingItems.foodTorchFlower, world.rand.nextInt(3) + 1), new ItemStack(BetterThanFarmingItems.foodTorchFlower)};
	}
}
